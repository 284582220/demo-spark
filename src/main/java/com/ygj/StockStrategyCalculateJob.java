...
public class StockStrategyCalculateJob {
    ...
    private static final Logger log = LoggerFactory.getLogger(StockStrategyCalculateJob.class);
...
//        SparkSession spark = SparkSession.builder().appName("stock-strategy-calculator").getOrCreate();
//        JavaRDD<String> lines = spark.read().textFile(args[0], 1).javaRDD();
